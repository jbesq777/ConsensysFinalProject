function createStore() 
{
  ...
  console.log("New Store (account:"+account+", storename:"+storename+", storedescription:"+storedescription+", amount:"+amount+")");
...
function loadStoreToForm()
{
  ...
  setInfo("This page is used to update the store information.");
...
function updateStore()
{
  ...
  console.log("Update store (sid:"+storeid+", storename:"+storename+", storedescription:"+storedescription+", amount:"+amount+")");

  // call the contract function
  MarketPlaceContract.updateStore(storeid, storename, storedescription, {from: account, gas: gaslimit}).then(function(txId) 
  {
		console.log(txId);
