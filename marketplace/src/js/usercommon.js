function createUser() 
{
  ...
  console.log("New User (account:"+account+", username:"+username+", usertype:"+usertype+", amount:"+amount+")");

  // call the contract function
  MarketPlaceContract.createUser(account, username, usertype, amount, {from: account, gas: gaslimit}).then(function(txId) 
	{
		console.log(txId);
...
function updateUser()
{
  ...
  console.log("Update User (uid:"+userid+", account:"+account+", username:"+username+",usertype:"+usertype+", amount:"+amount+")");

  // call the contract function
  MarketPlaceContract.updateUser(userid, username, usertype, {from: account, gas: gaslimit}).then(function(txId) 
  {
		console.log(txId);
    if (txId["receipt"]["gasUsed"] == gaslimit) 
    {
